...
```
cd existing_repo
git remote add origin https://gitlab.com/my-work14/lucky7-microservices/book-store.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/my-work14/lucky7-microservices/book-store/-/settings/integrations)
